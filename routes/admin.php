...
use App\Http\Controllers\Admin\DetallesalidaController;
use App\Http\Controllers\Admin\NotasalidaController;
...
//para la nota de salidas
Route::resource('notasalidas', NotasalidaController::class)->names('admin.notasalidas');//listar todas las notas de salidas
Route::get('notasalidas/pdf/{id}',[NotasalidaController::class,'pdf'])->name('admin.notasalidas.pdf');
