...
<form action="{{ route ('admin.clientes.store')}}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input autocomplete="off" id="apellidopaterno" name="apellidopaterno" type="text" class="form-control" tabindex="2"
        placeholder="Ingrese el apellido paterno del cliente">
    </div>

    <div class="mb-3">
      <label for="" class="form-label">Apellido Materno</label>
      <input autocomplete="off" id="apellidomaterno" name="apellidomaterno" type="text" class="form-control" tabindex="3"
    ...
    <div class="mb-3">
      ...
      <input autocomplete="off" id="telefono" name="telefono" type="number" class="form-control" tabindex="6" placeholder="Ingrese el numero telefonico del cliente">
    </div>
