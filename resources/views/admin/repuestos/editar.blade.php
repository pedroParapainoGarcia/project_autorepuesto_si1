...
<form action="{{ route ('admin.repuestos.update',$repuesto->id)}}" method="POST">
  ...
  <div class="mb-3">   
    <div class="form-group">       
        {{ Form::label ('Nombre')}}
        {{Form::select('id_nombrerepuesto',$nombrerepuesto,$repuesto->id_nombrerepuesto,['class' => 'form-control' .($errors->has('id_nombrerepuesto') ? ' is-invalid' : '')]) }}
...
<div class="mb-3">
  ...
  <div class="mb-3">
    <div class="form-group">
      ...
      {{Form::select('id_categoria',$categoria,$repuesto->id_categoria,['class' => 'form-control' .($errors->has('id_categoria') ? 'is-invalid' : '')]) }}
  ...
  <div class="mb-3">
    <div class="form-group">
      {{ Form::label ('Año')}}
      {{Form::select('id_año',$año,$repuesto->id_año,['class' => 'form-control' .($errors->has('id_año') ? 'is-invalid' : '')]) }}
