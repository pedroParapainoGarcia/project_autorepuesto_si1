...
<form action="{{ route ('admin.detallecompras.store')}}" method="POST">
  ...
  <div class="mb-3">
    ...
    <input id="id_notadecompra" name="id_notadecompra" type="number" step="any" value="{{$id}}" class="form-control" tabindex="1"
  ...
  <div class="mb-3">
    ...
    <input id="costounitario" name="costounitario" type="number" step="0.01" min="0" class="form-control" tabindex="3" placeholder="Ingrese el Costo Unitario del Repuesto">
  </div>
